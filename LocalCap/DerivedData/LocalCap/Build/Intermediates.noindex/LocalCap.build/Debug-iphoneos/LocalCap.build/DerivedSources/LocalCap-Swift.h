...
#ifndef LOCALCAP_SWIFT_H
#define LOCALCAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LocalCap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8LocalCap11AppDelegate")
...
SWIFT_CLASS("_TtC8LocalCap13SceneDelegate")
...
SWIFT_CLASS("_TtC8LocalCap14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(LocalCap)) <AVCaptureMetadataOutputObjectsDelegate>
...
SWIFT_CLASS("_TtC8LocalCap17ViewControllerWeb")
@interface ViewControllerWeb : UIViewController
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
@property (nonatomic, readonly) BOOL shouldAutorotate;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified mylabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified cogwheelButton;
- (void)viewDidLoad;
- (IBAction)cogWheelButtonTapped:(UIButton * _Nonnull)sender;
...
@interface ViewControllerWeb (SWIFT_EXTENSION(LocalCap)) <AVCaptureFileOutputRecordingDelegate>
